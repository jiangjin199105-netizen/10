...
**Windows 用户：**
直接双击运行项目根目录下的 **`启动程序.bat`** 脚本即可。它会自动安装依赖并启动程序。
...
启动成功后，浏览器会自动打开 `http://localhost:3000`。如果未自动打开，请手动访问。

**注意：** 程序运行时，请勿关闭弹出的黑色终端窗口，否则服务将停止。

如果您无法启动，请查看项目根目录下的 **`启动说明.html`** 文件。
