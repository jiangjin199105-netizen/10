@echo off
chcp 65001 >nul
title 开奖大师 - 全自动投注系统 (v16.0 网页控制台版)

echo ========================================================
echo          开奖大师 - 全自动投注系统 (v16.0 网页控制台版)
echo ========================================================
echo.
echo [提示] 正在检查运行环境...
...
echo.
echo [使用说明]
echo 1. 网页打开后，点击右上角【设置】或【脚本控制台】获取最新按键精灵代码。
echo 2. 将代码复制到按键精灵中运行。
echo 3. 脚本运行后会自动弹出网页控制台，并在其中实时显示日志。
echo ========================================================
echo.
